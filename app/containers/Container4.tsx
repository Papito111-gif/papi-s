  ...
  return (
    <div className="p-6 bg-white">
      ...
      <h2 className="text-5xl font-semibold text-black">
        Find your next<br /> property
      </h2>
      <div className="flex gap-4 mt-4">
        <span className="text-red-500 font-semibold border-b-2 border-red-500">
          Properties for sale
        </span>
          ...
          {properties.map((property) => (
            <div key={property.id} className="shadow-lg rounded-lg overflow-hidden">
              <div className="relative">
                ...
                />
                <span className="absolute bottom-2 left-2 text-white text-2xl font-bold px-2 py-1 rounded">
                  For Sale
                </span>
              </div>
              <div className="p-4">
